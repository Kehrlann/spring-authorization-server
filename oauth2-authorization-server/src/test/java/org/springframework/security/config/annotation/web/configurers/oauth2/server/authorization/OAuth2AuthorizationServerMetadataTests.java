...
/**
 * Integration tests for OAuth 2.0 Authorization Server Metadata.
 *
...
public class OAuth2AuthorizationServerMetadataTests {
	...
	@Test
	public void requestWhenServerMetadataRequestAndIssuerSetThenReturnServerMetadataResponse() throws Exception {
	...
	@Test
	public void requestWhenServerMetadataRequestAndIssuerNotSetThenRedirectToLogin() throws Exception {
		this.spring.register(AuthorizationServerConfiguration.class).autowire();

		MvcResult mvcResult = this.mvc.perform(get(OAuth2AuthorizationServerMetadataEndpointFilter.DEFAULT_OAUTH2_AUTHORIZATION_SERVER_METADATA_ENDPOINT_URI))
