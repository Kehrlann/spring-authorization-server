...
public class OAuth2AuthorizationServerMetadataHttpMessageConverter
	...
	protected OAuth2AuthorizationServerMetadata readInternal(Class<? extends OAuth2AuthorizationServerMetadata> clazz, HttpInputMessage inputMessage)
		...
		try {
			Map<String, Object> serverMetadataParameters =
					(Map<String, Object>) this.jsonMessageConverter.read(STRING_OBJECT_MAP.getType(), null, inputMessage);
			return this.authorizationServerMetadataConverter.convert(serverMetadataParameters);
		} catch (Exception ex) {
	...
	@Override
	protected void writeInternal(OAuth2AuthorizationServerMetadata providerConfiguration, HttpOutputMessage outputMessage)
			throws HttpMessageNotWritableException {
		try {
			Map<String, Object> providerConfigurationResponseParameters =
					this.authorizationServerMetadataParametersConverter.convert(providerConfiguration);
	 ...
	 */
	public void setAuthorizationServerMetadataConverter(Converter<Map<String, Object>, OAuth2AuthorizationServerMetadata> authorizationServerMetadataConverter) {
	 ...
	 * {@code Map} representation of the OAuth 2.0 Authorization Server Metadata.
	 */
	public void setAuthorizationServerMetadataParametersConverter(Converter<OAuth2AuthorizationServerMetadata, Map<String, Object>> authorizationServerMetadataParametersConverter) {
