...
/**
 * The names of the "claims" defined by RFC 8414 - OAuth 2.0 Authorization Server Metadata
 * that can be returned in the OAuth 2.0 Authorization Server Metadata Response.
 *
 * @author Daniel Garnier-Moiroux
 * @since 0.1.0
 * @see AuthorizationServerMetadataClaimNames
 * @see <a target="_blank" href="https://tools.ietf.org/html/rfc8414#section-2">2. Authorization Server Metadata</a>
 */
public interface OAuth2AuthorizationServerMetadataClaimNames extends AuthorizationServerMetadataClaimNames {
